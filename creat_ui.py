...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(9, 10, 401, 51))
        self.horizontalLayoutWidget_2.setObjectName("horizontalLayoutWidget_2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.Size_labe = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.Size_labe.setFocusPolicy(QtCore.Qt.NoFocus)
        self.Size_labe.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.Size_labe.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.Size_labe.setTextFormat(QtCore.Qt.AutoText)
        self.Size_labe.setIndent(-1)
        self.Size_labe.setObjectName("Size_labe")
        self.horizontalLayout_2.addWidget(self.Size_labe)
        self.Sizesld = QtWidgets.QSlider(self.horizontalLayoutWidget_2)
        self.Sizesld.setOrientation(QtCore.Qt.Horizontal)
        self.Sizesld.setObjectName("Sizesld")
        self.horizontalLayout_2.addWidget(self.Sizesld)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.radioButton_5)
        self.tabWidget.addTab(self.tab_2, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.tab_3)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 441, 201))
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 441, 201))
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.radioButton_3)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.radioButton_6)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.radioButton_8)
        self.radioButton_11 = QtWidgets.QRadioButton(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.radioButton_11.setFont(font)
        self.radioButton_11.setObjectName("radioButton_11")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.radioButton_11)
        self.radioButton_14 = QtWidgets.QRadioButton(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.radioButton_14.setFont(font)
        self.radioButton_14.setObjectName("radioButton_14")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.radioButton_14)
        self.radioButton_13 = QtWidgets.QRadioButton(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.radioButton_13.setFont(font)
        self.radioButton_13.setObjectName("radioButton_13")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.radioButton_13)
        self.radioButton_10 = QtWidgets.QRadioButton(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.radioButton_10.setFont(font)
        self.radioButton_10.setObjectName("radioButton_10")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.radioButton_10)
        ...
        self.menu_Perspective_Transform.addAction(self.actionThresholding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Size_labe.setText(_translate("MainWindow", "0"))
        ...
        self.radioButton_2.setText(_translate("MainWindow", "Gray"))
        self.radioButton_4.setText(_translate("MainWindow", "Hsv"))
        self.radioButton_5.setText(_translate("MainWindow", "Bgr"))
        ...
        self.radioButton.setText(_translate("MainWindow", "均值濾波(Mean Filtering)"))
        self.radioButton_3.setText(_translate("MainWindow", "高斯濾波(Gaussian Filtering)"))
        self.radioButton_6.setText(_translate("MainWindow", "影像浮雕(Emboss Image)"))
        self.radioButton_8.setText(_translate("MainWindow", "雙邊濾波(Bilateral filter)"))
        self.radioButton_11.setText(_translate("MainWindow", "中值濾波(MedianBlur)"))
        self.radioButton_14.setText(_translate("MainWindow", "邊緣檢測(Edge Detection Image)"))
        self.radioButton_13.setText(_translate("MainWindow", "索伯算子(Sobel filter)"))
        self.radioButton_10.setText(_translate("MainWindow", "增加高斯噪點(Add gaussian noise)"))
