...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_8.setGeometry(QtCore.QRect(0, 0, 441, 201))
        ...
        self.DilationradioButton = QtWidgets.QRadioButton(self.verticalLayoutWidget_8)
        self.DilationradioButton.setObjectName("DilationradioButton")
        self.horizontalLayout.addWidget(self.DilationradioButton)
        self.ErosionradioButton = QtWidgets.QRadioButton(self.verticalLayoutWidget_8)
        self.ErosionradioButton.setObjectName("ErosionradioButton")
        self.horizontalLayout.addWidget(self.ErosionradioButton)
        self.verticalLayout_8.addLayout(self.horizontalLayout)
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.MorphologicalOperations_label = QtWidgets.QLabel(self.verticalLayoutWidget_8)
        self.MorphologicalOperations_label.setFocusPolicy(QtCore.Qt.NoFocus)
        self.MorphologicalOperations_label.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.MorphologicalOperations_label.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.MorphologicalOperations_label.setTextFormat(QtCore.Qt.AutoText)
        self.MorphologicalOperations_label.setIndent(-1)
        self.MorphologicalOperations_label.setObjectName("MorphologicalOperations_label")
        self.horizontalLayout_17.addWidget(self.MorphologicalOperations_label)
        self.MorphologicalOperationssld = QtWidgets.QSlider(self.verticalLayoutWidget_8)
        self.MorphologicalOperationssld.setMaximum(255)
        self.MorphologicalOperationssld.setSingleStep(5)
        self.MorphologicalOperationssld.setTracking(True)
        self.MorphologicalOperationssld.setOrientation(QtCore.Qt.Horizontal)
        self.MorphologicalOperationssld.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.MorphologicalOperationssld.setTickInterval(0)
        self.MorphologicalOperationssld.setObjectName("MorphologicalOperationssld")
        self.horizontalLayout_17.addWidget(self.MorphologicalOperationssld)
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 0, 431, 71))
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayoutWidget_13 = QtWidgets.QWidget(self.groupBox)
        self.horizontalLayoutWidget_13.setGeometry(QtCore.QRect(10, 10, 401, 51))
        ...
        self.cornerHarris_labe = QtWidgets.QLabel(self.horizontalLayoutWidget_13)
        self.cornerHarris_labe.setFocusPolicy(QtCore.Qt.NoFocus)
        self.cornerHarris_labe.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.cornerHarris_labe.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.cornerHarris_labe.setTextFormat(QtCore.Qt.AutoText)
        self.cornerHarris_labe.setIndent(-1)
        self.cornerHarris_labe.setObjectName("cornerHarris_labe")
        self.horizontalLayout_18.addWidget(self.cornerHarris_labe)
        self.cornerHarrissld = QtWidgets.QSlider(self.horizontalLayoutWidget_13)
        self.cornerHarrissld.setMaximum(255)
        self.cornerHarrissld.setSingleStep(5)
        self.cornerHarrissld.setTracking(True)
        self.cornerHarrissld.setOrientation(QtCore.Qt.Horizontal)
        self.cornerHarrissld.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.cornerHarrissld.setTickInterval(0)
        self.cornerHarrissld.setObjectName("cornerHarrissld")
        self.horizontalLayout_18.addWidget(self.cornerHarrissld)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DilationradioButton.setText(_translate("MainWindow", "Erosion 影像侵蝕"))
        self.ErosionradioButton.setText(_translate("MainWindow", "Dilation 影像膨脹"))
        self.MorphologicalOperations_label.setText(_translate("MainWindow", "0"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("MainWindow", "morphological operations"))
        self.groupBox.setTitle(_translate("MainWindow", "cornerHarris"))
        self.cornerHarris_labe.setText(_translate("MainWindow", "0"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("MainWindow", "cornerHarris"))
